...
const cards: NewsCard[] = [
  ...
  },
  {
    ...
    href: "/news/news-hearing.html",
    badge: "HEARING",
    accent: "from-blue-900 to-amber-600",
    tileBg: "bg-[#0a1530]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-white">
        <div className="mb-2 flex items-center gap-2">
        ...
        <div className="text-2xl">🎤</div>
        <div className="mt-2 font-black text-sm tracking-widest text-amber-400">산자위</div>
        <div className="mt-1 text-[9px] tracking-widest opacity-70">제413회 청문회</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    href: "/news/news-sports-broadcast.html",
    badge: "SPORTS",
    accent: "from-red-500 via-blue-600 to-blue-900",
    tileBg: "bg-[#0a1530]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-white">
        <div className="mb-2 flex items-center gap-2">
        ...
        <div className="font-black text-base tracking-widest">SPARK·SPORTS</div>
        <div className="mt-2 flex items-center gap-2">
          <svg viewBox="0 0 24 24" className="h-6 w-6 fill-white">
            <circle cx="12" cy="12" r="10" stroke="#0a1530" strokeWidth="0.5" />
            <path d="M5 7c3 1 5 3 6 6M19 17c-3-1-5-3-6-6" stroke="#b8161a" strokeWidth="0.8" fill="none" />
          </svg>
          <div className="rounded bg-white/10 px-2 py-0.5 text-[10px] font-mono">
            <span className="text-red-300">OHM</span> 3 : 2 <span className="text-blue-300">FAR</span>
          </div>
        </div>
        <div className="mt-1 text-[9px] tracking-widest opacity-70">7회말 2아웃</div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-music-festival.html",
    badge: "FESTIVAL",
    accent: "from-pink-500 via-purple-500 to-cyan-400",
    tileBg: "bg-black",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-white">
        <div className="text-[10px] tracking-[0.4em] text-pink-400">★ 2026 ★</div>
        <div
          className="mt-1 font-black text-base leading-tight tracking-tight"
          style={{ textShadow: "0 0 8px #ec4899, 0 0 16px #a855f7, 0 0 24px #22d3ee" }}
        >
          ELECTRIC SPARK
        </div>
        <div className="mt-1 text-[9px] tracking-[0.3em] text-cyan-300">FESTIVAL</div>
        <svg viewBox="0 0 120 20" className="mt-2 h-5 w-24">
          <path
            d="M0 10 L10 10 L14 4 L18 16 L22 6 L26 14 L30 10 L40 10 L44 2 L48 18 L52 8 L56 12 L60 10 L70 10 L74 5 L78 15 L82 7 L86 13 L90 10 L120 10"
            stroke="#22d3ee"
            strokeWidth="1.2"
            fill="none"
          />
  ...
  },
  {
    ...
    href: "/news/news-detective.html",
    badge: "DETECTIVE",
    accent: "from-amber-900 to-emerald-900",
    tileBg: "bg-[#3b2a1a]",
    tileContent: (
      <div className="absolute inset-0 p-3">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 30%, rgba(255,255,255,0.04) 0 1px, transparent 1px), radial-gradient(circle at 70% 60%, rgba(0,0,0,0.15) 0 1px, transparent 1px)",
            backgroundSize: "6px 6px, 8px 8px",
            backgroundColor: "#a47148",
          }}
        >
          <span className="absolute left-2 top-2 inline-block h-2 w-2 rounded-full bg-red-600 shadow" />
          <span className="absolute right-3 top-3 inline-block h-2 w-2 rounded-full bg-red-600 shadow" />
          <span className="absolute bottom-3 left-4 inline-block h-2 w-2 rounded-full bg-red-600 shadow" />
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="rotate-[-3deg] bg-[#f5ecd6] px-2 py-1 shadow font-mono text-[10px] font-bold tracking-widest text-[#3b2a1a]">
              FILE #2026-052
            </div>
          </div>
          <svg className="absolute inset-0 h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <line x1="8" y1="8" x2="92" y2="92" stroke="#dc2626" strokeWidth="0.5" />
          </svg>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    href: "/news/news-escape-room.html",
    badge: "ESCAPE",
    accent: "from-red-700 to-amber-700",
    tileBg: "bg-[#1a0a0a]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-amber-300">
        <svg viewBox="0 0 24 28" className="h-10 w-9">
          <rect x="4" y="12" width="16" height="14" rx="2" fill="#d4a04a" stroke="#7a5418" strokeWidth="0.6" />
          <path
            d="M8 12 V8 a4 4 0 0 1 8 0 V12"
            stroke="#d4a04a"
            strokeWidth="1.6"
            fill="none"
          />
          <circle cx="12" cy="19" r="1.5" fill="#3b1a08" />
          <rect x="11.4" y="19" width="1.2" height="4" fill="#3b1a08" />
        </svg>
        <div
          className="mt-2 font-serif text-xl font-black tracking-[0.2em]"
          style={{ textShadow: "0 0 6px rgba(217,119,6,0.6)" }}
        >
          ESCAPE
        </div>
        <div className="mt-1 text-[11px] tracking-widest text-red-500">★★★★★</div>
        <div className="mt-1 text-[9px] tracking-widest opacity-60">6 ROOMS · MYSTERY</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    href: "/news/news-vinyl.html",
    badge: "VINYL",
    accent: "from-amber-700 to-stone-800",
    tileBg: "bg-[#15100a]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-amber-200">
        <svg viewBox="0 0 64 64" className="h-24 w-24">
          <circle cx="32" cy="32" r="30" fill="#0a0705" />
          <circle cx="32" cy="32" r="29" fill="none" stroke="#3a2a1a" strokeWidth="0.3" />
          <circle cx="32" cy="32" r="25" fill="none" stroke="#2a1c10" strokeWidth="0.3" />
          <circle cx="32" cy="32" r="20" fill="none" stroke="#3a2a1a" strokeWidth="0.3" />
          <circle cx="32" cy="32" r="16" fill="none" stroke="#2a1c10" strokeWidth="0.3" />
          <circle cx="32" cy="32" r="11" fill="#c89545" />
          <circle cx="32" cy="32" r="10" fill="none" stroke="#7a5418" strokeWidth="0.4" />
          <text
            x="32"
            y="30"
            fontSize="3"
          ...
          <circle cx="32" cy="32" r="1.4" fill="#0a0705" />
        </svg>
        <div className="mt-2 font-serif text-[10px] italic tracking-widest text-amber-300">
          Est. 1962
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-startup-pitch.html",
    badge: "PITCH",
    accent: "from-orange-500 to-blue-700",
    tileBg: "bg-white",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-zinc-900">
        <div className="text-[9px] tracking-[0.3em] text-zinc-400">SLIDE 01 / 12</div>
        <div className="mt-2 font-black text-2xl tracking-tight leading-none">
          <span className="text-orange-500">Spark</span>
          <span className="text-blue-700">ssaem</span>
        </div>
        <div className="mt-1 text-[9px] tracking-widest text-zinc-500">DEMO DAY · 2026</div>
        <div className="mt-3 inline-block rounded-full bg-gradient-to-r from-orange-500 to-blue-700 px-2.5 py-0.5 text-[9px] font-bold tracking-widest text-white">
          SEED ROUND
        </div>
        <div className="mt-3 h-1 w-32 rounded bg-zinc-200">
          <div className="h-full w-[68%] rounded bg-gradient-to-r from-orange-500 to-blue-700" />
        </div>
        <div className="mt-1 text-[8px] text-zinc-400">3.4억 / 5억 달성</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    href: "/news/news-gym-tracker.html",
    badge: "FITNESS",
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 text-white">
        <div className="relative flex h-32 w-32 items-center justify-center">
          <svg viewBox="0 0 64 64" className="absolute inset-0 h-full w-full -rotate-90">
            <circle cx="32" cy="32" r="28" fill="none" stroke="#0f1830" strokeWidth="5" />
            <circle
              cx="32"
              cy="32"
              r="28"
          ...
          <div className="relative flex flex-col items-center">
            <div className="font-mono text-2xl font-black tracking-tight tabular-nums">47:32</div>
            <div className="mt-0.5 flex items-center gap-1 text-[9px] font-bold text-cyan-300">
              <span className="animate-pulse text-pink-400">♥</span>
              <span className="font-mono">128 bpm</span>
            </div>
            <div className="text-[8px] tracking-widest text-orange-400">77% DAILY</div>
          </div>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    href: "/news/news-fortune.html",
    badge: "FORTUNE",
    accent: "from-purple-600 via-yellow-400 to-purple-900",
    tileBg: "bg-[#0e0820]",
    tileContent: (
      <div className="absolute inset-0 overflow-hidden">
        {/* 별빛 */}
        <div className="absolute left-[12%] top-[18%] h-0.5 w-0.5 rounded-full bg-yellow-200" />
        <div className="absolute left-[28%] top-[12%] h-0.5 w-0.5 rounded-full bg-white" />
        <div className="absolute left-[78%] top-[20%] h-1 w-1 rounded-full bg-yellow-100 shadow-[0_0_4px_rgba(253,224,71,0.8)]" />
        <div className="absolute left-[88%] top-[36%] h-0.5 w-0.5 rounded-full bg-white" />
        <div className="absolute left-[18%] top-[68%] h-0.5 w-0.5 rounded-full bg-yellow-200" />
        <div className="absolute left-[72%] top-[78%] h-0.5 w-0.5 rounded-full bg-white" />
        <div className="absolute left-[42%] top-[8%] h-0.5 w-0.5 rounded-full bg-yellow-100" />
        <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-yellow-100">
          <svg viewBox="0 0 32 32" className="h-10 w-10">
            ...
            <circle cx="14" cy="16" r="10" fill="url(#moonGrad)" />
            <circle cx="17" cy="14" r="9" fill="#0e0820" />
          </svg>
          <div className="mt-1 font-serif text-2xl font-black italic tracking-widest text-yellow-200 drop-shadow-[0_0_6px_rgba(250,204,21,0.4)]">
            TAROT
          </div>
          <div className="mt-2 flex gap-1">
            <div className="h-10 w-6 rounded-sm border border-yellow-400/60 bg-purple-900/80 shadow-[0_0_4px_rgba(168,85,247,0.5)]" />
            <div className="h-10 w-6 -translate-y-1 rounded-sm border border-yellow-300 bg-purple-800/90 shadow-[0_0_6px_rgba(250,204,21,0.5)]" />
            <div className="h-10 w-6 rounded-sm border border-yellow-400/60 bg-purple-900/80 shadow-[0_0_4px_rgba(168,85,247,0.5)]" />
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    href: "/news/news-awards-ceremony.html",
    badge: "AWARDS",
    accent: "from-yellow-400 via-red-700 to-black",
    tileBg: "bg-black",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-yellow-300">
        ...
        <svg viewBox="0 0 32 40" className="h-16 w-12 drop-shadow-[0_0_6px_rgba(250,204,21,0.5)]">
          <defs>
          ...
          <path d="M8 4 H24 V14 a8 8 0 0 1 -16 0 Z" fill="url(#trophyGrad)" stroke="#713f12" strokeWidth="0.5" />
          <path d="M8 7 Q3 7 3 11 Q3 14 8 14" stroke="#a16207" strokeWidth="1.2" fill="none" />
          <path d="M24 7 Q29 7 29 11 Q29 14 24 14" stroke="#a16207" strokeWidth="1.2" fill="none" />
          <rect x="14" y="22" width="4" height="6" fill="#a16207" />
          <rect x="10" y="28" width="12" height="3" fill="#facc15" stroke="#713f12" strokeWidth="0.4" />
          <rect x="8" y="31" width="16" height="5" fill="#a16207" stroke="#713f12" strokeWidth="0.4" />
          <text x="16" y="35" fontSize="3" fill="#fde68a" textAnchor="middle" fontFamily="serif" fontWeight="bold">2026</text>
        </svg>
        <div
          className="mt-2 font-serif text-base font-black tracking-[0.3em]"
          style={{ textShadow: "0 0 6px rgba(250,204,21,0.5)" }}
        >
          AWARDS
        </div>
        <div className="mt-1 text-[8px] tracking-widest text-yellow-200/70">ELECTRIC · 2026</div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-passport.html",
    badge: "PASSPORT",
    accent: "from-blue-900 to-amber-700",
    tileBg: "bg-[#0e1c3d]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-amber-300">
        <svg viewBox="0 0 32 36" className="h-14 w-12">
          <defs>
          ...
          <path
            d="M16 1 L29 6 V18 Q29 28 16 34 Q3 28 3 18 V6 Z"
            fill="none"
            stroke="url(#emblemGrad)"
            strokeWidth="1.2"
          />
          <path
            d="M16 8 L13 16 L18 16 L14 24 L20 14 L15 14 L19 8 Z"
            fill="url(#emblemGrad)"
            stroke="#fde68a"
            strokeWidth="0.3"
          />
        ...
        <div
          className="mt-2 font-serif text-base font-black tracking-[0.3em]"
          style={{ textShadow: "0 0 4px rgba(217,119,6,0.4)" }}
        >
          PASSPORT
        </div>
        <div className="mt-1 text-[8px] font-serif italic tracking-widest text-amber-200/70">
          REPUBLIC OF VOLTANIA
        </div>
        <div className="mt-1 h-px w-16 bg-amber-300/40" />
        <div className="mt-1 text-[8px] tracking-widest text-amber-200/60">電氣共和國</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    href: "/news/news-vending-machine.html",
    badge: "VENDING",
    accent: "from-cyan-400 to-blue-700",
    tileBg: "bg-[#0a0e1a]",
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center p-3">
        <div className="relative h-full w-24 rounded-md border-2 border-cyan-400/60 bg-gradient-to-b from-[#0f1830] to-[#050810] shadow-[inset_0_0_12px_rgba(34,211,238,0.35)]">
          <div className="absolute left-1.5 right-1.5 top-1.5 grid grid-cols-3 gap-0.5">
            {Array.from({ length: 9 }).map((_, i) => (
              <div key={i} className="aspect-square rounded-sm border border-cyan-300/30 bg-[#0a1228]" />
            ))}
          </div>
          <div className="absolute left-1.5 right-1.5 top-[58%] rounded-sm bg-[#001018] px-1 py-0.5 text-center font-mono text-[9px] font-bold text-cyan-300 shadow-[inset_0_0_4px_rgba(34,211,238,0.6)]">
            ₸ 2,500
          </div>
          <div className="absolute left-1.5 right-1.5 bottom-3 grid grid-cols-3 gap-0.5">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="aspect-square rounded-[1px] border border-cyan-300/40 bg-[#0a1430] text-center font-mono text-[6px] leading-none text-cyan-200/80 flex items-center justify-center">
                {i + 1}
              </div>
            ))}
          </div>
          <div className="absolute left-1.5 right-1.5 bottom-0.5 h-1.5 rounded-sm border border-cyan-300/40 bg-black/60" />
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-prescription.html",
    badge: "PHARMACY",
    accent: "from-emerald-500 to-emerald-800",
    tileBg: "bg-white",
    tileContent: (
      <div
        className="absolute inset-0 flex flex-col items-center justify-center p-3 text-emerald-800"
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent 0 11px, rgba(16,185,129,0.07) 11px 12px)",
        }}
      >
        <div className="flex items-center gap-2">
          <div className="font-serif text-5xl font-black leading-none italic text-emerald-700">℞</div>
          <div className="flex h-7 w-7 items-center justify-center rounded-sm bg-emerald-600">
            <div className="absolute h-5 w-1.5 bg-white" />
            <div className="h-1.5 w-5 bg-white" />
          </div>
        </div>
        <div className="mt-2 rounded-sm border border-emerald-700/60 bg-white/80 px-2 py-0.5 text-[9px] font-bold tracking-[0.25em] text-emerald-800">
          Rx · PRESCRIPTION
        </div>
        <div className="mt-1.5 text-[9px] font-semibold tracking-widest text-emerald-700/80">SPARK PHARMACY</div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-hotel-room-service.html",
    badge: "HOTEL",
    accent: "from-blue-900 to-yellow-600",
    tileBg: "bg-[#0a1f4a]",
    tileContent: (
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-white">
        ...
        <div className="mt-2 font-serif text-lg font-black tracking-wide text-yellow-300">SPARK GRAND</div>
        <div className="text-[8px] tracking-[0.4em] text-yellow-200/80">HOTEL · EST. 2026</div>
        <div className="mt-2 rounded-sm border border-yellow-400/70 bg-[#06163a] px-2 py-1 text-center shadow-[0_0_10px_rgba(250,204,21,0.25)]">
          <div className="text-[7px] tracking-[0.3em] text-yellow-200/70">ROOM KEY</div>
          <div className="font-mono text-xs font-bold tracking-widest text-yellow-300">1208</div>
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-satellite-tracker.html",
    badge: "SATELLITE",
    ...
    tileContent: (
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(1px 1px at 12% 20%, rgba(255,255,255,0.9), transparent), radial-gradient(1px 1px at 28% 70%, rgba(255,255,255,0.7), transparent), radial-gradient(1px 1px at 55% 35%, rgba(255,255,255,0.8), transparent), radial-gradient(1px 1px at 78% 60%, rgba(255,255,255,0.6), transparent), radial-gradient(1px 1px at 88% 18%, rgba(255,255,255,0.9), transparent), radial-gradient(1px 1px at 40% 88%, rgba(255,255,255,0.5), transparent)",
        }}
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <svg viewBox="0 0 64 64" className="h-16 w-16 opacity-90">
            <defs>
            ...
            <circle cx="32" cy="32" r="22" fill="url(#earthGrad)" stroke="#67e8f9" strokeWidth="0.6" />
            <ellipse cx="32" cy="32" rx="22" ry="7" fill="none" stroke="#67e8f9" strokeWidth="0.4" opacity="0.6" />
            <ellipse cx="32" cy="32" rx="7" ry="22" fill="none" stroke="#67e8f9" strokeWidth="0.4" opacity="0.6" />
            <path d="M14 30 Q22 26 28 30 T44 28 Q50 26 52 30" fill="none" stroke="#86efac" strokeWidth="0.7" opacity="0.8" />
            <circle cx="48" cy="14" r="1.4" fill="#22d3ee" />
            <circle cx="14" cy="46" r="1.2" fill="#86efac" />
          </svg>
          <div className="mt-1.5 rounded-sm border border-cyan-400/60 bg-black/60 px-2 py-0.5 font-mono text-[9px] font-bold tracking-widest text-cyan-300 shadow-[0_0_6px_rgba(34,211,238,0.6)]">
            T+128d
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    href: "/news/news-department-store.html",
    badge: "DEPARTMENT",
    ...
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center gap-3 p-3">
        <div className="flex flex-col items-center">
          <div className="font-serif text-2xl font-black tracking-tight text-amber-700" style={{ fontFamily: "'Playfair Display', 'Times New Roman', serif" }}>
            SPARK
          </div>
          <div className="mt-0.5 text-[8px] font-bold tracking-[0.35em] text-amber-800/80">
            DEPARTMENT STORE
          </div>
          <div className="mt-1 h-px w-14 bg-amber-600/60" />
          <div className="mt-1 text-[7px] tracking-[0.3em] text-amber-700/60">EST · 2026</div>
        </div>
        <svg viewBox="0 0 24 44" className="h-20 w-10">
          <rect x="2" y="2" width="20" height="40" fill="#fde68a" stroke="#b45309" strokeWidth="0.6" />
          {Array.from({ length: 11 }).map((_, i) => (
            <g key={i}>
              <line x1="2" y1={6 + i * 3.5} x2="22" y2={6 + i * 3.5} stroke="#b45309" strokeWidth="0.3" opacity="0.7" />
              <rect x="5" y={3.2 + i * 3.5} width="2" height="1.6" fill="#b45309" opacity="0.55" />
              <rect x="9" y={3.2 + i * 3.5} width="2" height="1.6" fill="#b45309" opacity="0.55" />
              <rect x="13" y={3.2 + i * 3.5} width="2" height="1.6" fill="#b45309" opacity="0.55" />
              <rect x="17" y={3.2 + i * 3.5} width="2" height="1.6" fill="#b45309" opacity="0.55" />
            </g>
          ))}
        </svg>
      </div>
  ...
  },
  {
    ...
    href: "/news/news-graffiti.html",
    badge: "GRAFFITI",
    accent: "from-pink-500 via-cyan-400 to-lime-400",
    tileBg: "bg-[#2a2a2a]",
    tileContent: (
      <div
        className="absolute inset-0 overflow-hidden"
        style={{
          backgroundImage:
            "radial-gradient(1px 1px at 15% 30%, rgba(255,255,255,0.12), transparent), radial-gradient(1px 1px at 70% 20%, rgba(255,255,255,0.08), transparent), radial-gradient(1px 1px at 40% 75%, rgba(255,255,255,0.10), transparent), radial-gradient(2px 2px at 85% 65%, rgba(0,0,0,0.25), transparent)",
        }}
      >
        <div className="absolute inset-0 flex items-center justify-center gap-4 p-3">
          <div
            className="font-black text-5xl text-[#ec4899] drop-shadow-[0_0_8px_rgba(236,72,153,0.7)]"
            style={{ fontFamily: "'Permanent Marker', 'Impact', sans-serif", transform: "rotate(-6deg)" }}
          >
            Ω
          </div>
          <svg viewBox="0 0 24 36" className="h-14 w-10">
            <path
              d="M14 2 L4 20 H11 L8 34 L20 14 H13 Z"
              fill="#22d3ee"
              stroke="#67e8f9"
              strokeWidth="0.6"
          ...
          <svg viewBox="0 0 24 24" className="h-12 w-12">
            <rect x="3" y="10" width="18" height="4" fill="none" stroke="#a3e635" strokeWidth="1" style={{ filter: "drop-shadow(0 0 4px rgba(163,230,53,0.7))" }} />
            <circle cx="7" cy="12" r="1.4" fill="#a3e635" />
            <circle cx="17" cy="12" r="1.4" fill="#a3e635" />
            <line x1="12" y1="6" x2="12" y2="10" stroke="#a3e635" strokeWidth="1" />
            <line x1="12" y1="14" x2="12" y2="18" stroke="#a3e635" strokeWidth="1" />
          </svg>
        </div>
        <div className="absolute bottom-2 left-0 right-0 text-center text-[8px] font-bold tracking-[0.3em] text-white/70">
          STREET GALLERY
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-astrology.html",
    badge: "ASTROLOGY",
    accent: "from-purple-800 via-amber-400 to-indigo-900",
    tileBg: "bg-[#0a0625]",
    tileContent: (
      <div
        className="absolute inset-0 overflow-hidden"
      ...
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <svg viewBox="0 0 64 64" className="h-20 w-20">
            <circle cx="32" cy="32" r="26" fill="none" stroke="#fbbf24" strokeWidth="0.6" opacity="0.9" />
            <circle cx="32" cy="32" r="20" fill="none" stroke="#fbbf24" strokeWidth="0.4" opacity="0.7" />
            <circle cx="32" cy="32" r="14" fill="none" stroke="#fbbf24" strokeWidth="0.4" opacity="0.5" />
            {Array.from({ length: 12 }).map((_, i) => {
              ...
              return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#fbbf24" strokeWidth="0.5" opacity="0.9" />;
            })}
            <circle cx="32" cy="32" r="2.2" fill="#fde68a" />
          </svg>
          <div className="mt-1 flex items-center gap-2 text-amber-200">
            <span className="text-base">☉</span>
            <span className="text-[8px] tracking-[0.35em] opacity-80">ZODIAC</span>
            <span className="text-base">☽</span>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    href: "/news/news-karaoke.html",
    badge: "KARAOKE",
    accent: "from-pink-500 via-cyan-400 to-yellow-300",
    tileBg: "bg-[#0a0a14]",
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center gap-3 p-3">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-1 rounded-sm border border-cyan-400/70 bg-black/50 px-2 py-0.5 font-mono text-[9px] font-bold tracking-widest text-cyan-300 shadow-[0_0_6px_rgba(34,211,238,0.7)]">
            ROOM 7
          </div>
          <div className="mt-2 h-1 w-20 rounded bg-zinc-800 overflow-hidden">
            <div className="h-full w-[78%] bg-gradient-to-r from-pink-500 via-cyan-400 to-yellow-300" />
          </div>
          <div className="mt-1 font-mono text-[8px] text-yellow-300">SCORE 92</div>
        </div>
        <svg viewBox="0 0 20 36" className="h-14 w-10">
          <ellipse cx="10" cy="8" rx="6" ry="6" fill="#1f2937" stroke="#facc15" strokeWidth="0.6" />
          <ellipse cx="10" cy="8" rx="6" ry="6" fill="url(#micMesh)" opacity="0.7" />
          <defs>
            <pattern id="micMesh" width="2" height="2" patternUnits="userSpaceOnUse">
              <circle cx="1" cy="1" r="0.5" fill="#facc15" />
            </pattern>
          </defs>
          <rect x="9" y="14" width="2" height="10" fill="#facc15" />
          <rect x="6" y="24" width="8" height="3" rx="0.6" fill="#facc15" />
          <path d="M10 27 L10 34" stroke="#a16207" strokeWidth="0.6" />
        </svg>
      </div>
    ),
  },
  ...
  },
  {
    ...
    href: "/news/news-dna-test.html",
    badge: "DNA",
    accent: "from-purple-600 to-emerald-500",
    tileBg: "bg-white",
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center gap-3 p-3">
        <svg viewBox="0 0 40 80" className="h-28 w-16">
          <defs>
          ...
          <path
            d="M8 2 Q32 10 8 20 Q-16 30 8 40 Q32 50 8 60 Q-16 70 8 78"
            fill="none"
          ...
          />
          <path
            d="M32 2 Q8 10 32 20 Q56 30 32 40 Q8 50 32 60 Q56 70 32 78"
            fill="none"
        ...
        <div className="flex flex-col items-center">
          <div className="font-mono text-[8px] tracking-[0.3em] text-zinc-500">
            SAMPLE ID
          </div>
          <div className="mt-0.5 rounded-sm border border-purple-300 bg-purple-50 px-2 py-0.5 font-mono text-[10px] font-bold text-purple-700">
            DNA-7321
          </div>
          <div className="mt-2 h-px w-14 bg-zinc-300" />
          <div className="mt-1.5 font-mono text-[8px] tracking-widest text-emerald-600">
            ANALYZED
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    href: "/news/news-auction.html",
    badge: "AUCTION",
    accent: "from-yellow-400 to-blue-900",
    tileBg: "bg-[#0a1a3a]",
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center gap-3 p-3">
        <div className="flex flex-col items-center">
          <div
            className="font-black text-2xl tracking-wider text-[#facc15] drop-shadow-[0_0_6px_rgba(250,204,21,0.5)]"
            style={{ fontFamily: "'Playfair Display', 'Times New Roman', serif" }}
          >
            AUCTION
          </div>
          <div className="mt-0.5 text-[8px] font-bold tracking-[0.4em] text-yellow-200/80">
            EST. 1947
          </div>
          <div className="mt-1 h-px w-16 bg-yellow-400/70" />
          <div className="mt-1.5 flex items-center gap-1.5">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-red-500 opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-red-500" />
            </span>
            <span className="font-mono text-[9px] font-bold tracking-[0.25em] text-yellow-200">
              LOT #1 · LIVE
            </span>
          </div>
        </div>
        <svg viewBox="0 0 36 36" className="h-16 w-16" style={{ transform: "rotate(-15deg)" }}>
          <rect x="6" y="6" width="14" height="8" rx="1" fill="#facc15" stroke="#a16207" strokeWidth="0.6" />
          <rect x="9" y="3" width="8" height="2" fill="#a16207" />
          <rect x="9" y="15" width="8" height="2" fill="#a16207" />
          <rect x="18" y="14" width="2.5" height="18" fill="#a16207" />
          <rect x="14" y="30" width="14" height="3" rx="0.6" fill="#facc15" stroke="#a16207" strokeWidth="0.5" />
          <line x1="13" y1="9" x2="17" y2="9" stroke="#a16207" strokeWidth="0.6" />
        </svg>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-zoo.html",
    badge: "ZOO",
    accent: "from-green-500 to-yellow-500",
    tileBg: "bg-white",
    tileContent: (
      <div className="absolute inset-0 flex items-center justify-center gap-3 p-3">
        <svg viewBox="0 0 50 40" className="h-20 w-24">
          <rect x="6" y="14" width="4" height="24" fill="#a16207" />
          <rect x="40" y="14" width="4" height="24" fill="#a16207" />
          <path d="M4 14 Q25 -2 46 14 Z" fill="#16a34a" stroke="#166534" strokeWidth="0.6" />
          <rect x="22" y="22" width="6" height="16" fill="#facc15" stroke="#a16207" strokeWidth="0.5" />
          <line x1="25" y1="22" x2="25" y2="38" stroke="#a16207" strokeWidth="0.5" />
          <text x="25" y="11" textAnchor="middle" fontSize="3.2" fontWeight="900" fill="#fef3c7" fontFamily="'Impact', sans-serif">
            SPARK ZOO
          </text>
          <line x1="10" y1="20" x2="22" y2="20" stroke="#a16207" strokeWidth="0.4" />
          <line x1="10" y1="28" x2="22" y2="28" stroke="#a16207" strokeWidth="0.4" />
          <line x1="28" y1="20" x2="40" y2="20" stroke="#a16207" strokeWidth="0.4" />
          <line x1="28" y1="28" x2="40" y2="28" stroke="#a16207" strokeWidth="0.4" />
        </svg>
        <div className="flex flex-col items-center gap-1.5">
          <svg viewBox="0 0 28 24" className="h-10 w-12">
            <circle cx="14" cy="13" r="8" fill="#fbbf24" stroke="#a16207" strokeWidth="0.6" />
            <circle cx="6" cy="9" r="3" fill="#f59e0b" stroke="#a16207" strokeWidth="0.5" />
            <circle cx="22" cy="9" r="3" fill="#f59e0b" stroke="#a16207" strokeWidth="0.5" />
            <circle cx="14" cy="13" r="6.5" fill="none" stroke="#d97706" strokeWidth="0.4" />
            <circle cx="11" cy="12" r="0.9" fill="#1f2937" />
            <circle cx="17" cy="12" r="0.9" fill="#1f2937" />
            <path d="M14 14 L13 15.5 L15 15.5 Z" fill="#1f2937" />
            <path d="M12 17 Q14 18.5 16 17" fill="none" stroke="#1f2937" strokeWidth="0.5" strokeLinecap="round" />
          </svg>
          <svg viewBox="0 0 14 22" className="h-8 w-5">
            <circle cx="7" cy="6" r="5" fill="#ec4899" stroke="#be185d" strokeWidth="0.4" />
            <path d="M6 10.5 L7 11.5 L8 10.5 Z" fill="#ec4899" />
            <line x1="7" y1="11.5" x2="7" y2="21" stroke="#9ca3af" strokeWidth="0.4" />
          </svg>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    href: "/news/news-train-schedule.html",
    badge: "TRAIN",
    accent: "from-amber-400 via-emerald-500 to-blue-700",
    tileBg: "bg-[#0a0a14]",
    tileContent: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 p-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[9px] font-bold tracking-widest text-red-400">LIVE</span>
            <span
              className="font-mono text-xl font-black tracking-widest text-[#fbbf24] drop-shadow-[0_0_6px_rgba(251,191,36,0.8)]"
              style={{ fontFamily: "'Courier New', monospace" }}
            >
              DEPART
            </span>
          </div>
          <div className="w-full max-w-[140px] rounded border border-amber-500/30 bg-black/60 p-1.5 font-mono text-[8px] leading-tight text-amber-300">
            <div className="flex justify-between"><span>06:12</span><span>옴역</span><span className="text-emerald-400">정시</span></div>
            <div className="flex justify-between"><span>06:27</span><span>키르히호프</span><span className="text-emerald-400">정시</span></div>
            <div className="flex justify-between"><span>06:43</span><span>변압기</span><span className="text-amber-300">5분</span></div>
            <div className="flex justify-between"><span>07:01</span><span>합격역</span><span className="text-emerald-400">정시</span></div>
          </div>
          <div className="font-mono text-[8px] tracking-[0.3em] text-blue-300">SPARK · LINE 027</div>
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-kiosk.html",
    badge: "KIOSK",
    accent: "from-yellow-400 to-red-600",
    tileBg: "bg-white",
    tileContent: (
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-yellow-300 to-yellow-400" />
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 p-3">
          <div className="flex items-center gap-2">
            <svg viewBox="0 0 24 24" className="h-9 w-9">
              <ellipse cx="12" cy="7" rx="9" ry="3" fill="#fbbf24" stroke="#92400e" strokeWidth="0.6" />
              <rect x="3" y="10" width="18" height="2.5" rx="0.5" fill="#16a34a" />
              <rect x="3" y="12" width="18" height="2.5" rx="0.5" fill="#dc2626" />
              <rect x="3" y="14" width="18" height="2.5" rx="0.5" fill="#fde047" />
              <ellipse cx="12" cy="17" rx="9" ry="3" fill="#a16207" stroke="#451a03" strokeWidth="0.6" />
              <circle cx="7" cy="6" r="0.7" fill="#fef3c7" />
              <circle cx="15" cy="6.5" r="0.6" fill="#fef3c7" />
            </svg>
            <div className="flex h-12 w-16 items-center justify-center rounded-lg bg-red-600 font-black text-white shadow-lg ring-2 ring-red-800">
              <span className="text-base tracking-tight">주문</span>
            </div>
          </div>
          <div className="rounded-md bg-white px-3 py-1.5 text-center font-mono shadow-md">
            <div className="text-[8px] font-bold tracking-widest text-zinc-500">대기번호</div>
            <div className="text-base font-black leading-none text-red-600">A-027</div>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    href: "/news/news-camping.html",
    badge: "CAMPING",
    accent: "from-emerald-700 to-amber-800",
    tileBg: "bg-[#1f3a2d]",
    tileContent: (
      <div
        className="absolute inset-0 overflow-hidden"
        style={{
          backgroundImage:
            "radial-gradient(1px 1px at 18% 20%, rgba(255,255,255,0.85), transparent), radial-gradient(1px 1px at 70% 12%, rgba(255,255,255,0.7), transparent), radial-gradient(1px 1px at 38% 30%, rgba(255,255,255,0.6), transparent), radial-gradient(1px 1px at 85% 28%, rgba(255,255,255,0.75), transparent), radial-gradient(1px 1px at 55% 15%, rgba(255,255,255,0.5), transparent)",
        }}
      >
        <div className="absolute inset-0 flex flex-col items-center justify-end gap-2 p-3">
          <svg viewBox="0 0 40 24" className="h-12 w-20">
            <polygon points="20,2 4,22 36,22" fill="#065f46" stroke="#a3e635" strokeWidth="0.5" />
            <polygon points="20,2 14,22 26,22" fill="#064e3b" />
            <line x1="20" y1="2" x2="20" y2="22" stroke="#a3e635" strokeWidth="0.4" />
            <rect x="18" y="16" width="4" height="6" fill="#0a0a0a" />
          </svg>
          <div className="flex items-end gap-1">
            <svg viewBox="0 0 24 24" className="h-8 w-8">
              <path d="M12 4 C 10 8, 14 9, 12 14 C 10 9, 14 8, 12 4 Z" fill="#fbbf24" />
              <path d="M12 8 C 10.5 11, 13.5 12, 12 16 C 10.5 12, 13.5 11, 12 8 Z" fill="#f97316" />
              <path d="M12 11 C 11 13, 13 14, 12 17 C 11 14, 13 13, 12 11 Z" fill="#dc2626" />
              <line x1="6" y1="22" x2="12" y2="17" stroke="#78350f" strokeWidth="1.2" strokeLinecap="round" />
              <line x1="18" y1="22" x2="12" y2="17" stroke="#78350f" strokeWidth="1.2" strokeLinecap="round" />
              <line x1="9" y1="22" x2="14" y2="18" stroke="#78350f" strokeWidth="1.2" strokeLinecap="round" />
            </svg>
            <div className="font-mono text-[9px] font-bold tracking-widest text-amber-300 drop-shadow-[0_0_4px_rgba(251,191,36,0.6)]">
              SITE · 06
            </div>
          </div>
        </div>
